...
public final class AOPUtils {
     ...
     */
    public static <A extends Annotation> AnnotationAttributes getMethodAnnotationAttributes(JoinPoint joinPoint, Class<A> annotationType) {
     ...
     * @return {@link AnnotationAttributes} 实例
     */
    public static <A extends Annotation> AnnotationAttributes getTargetTypeAnnotationAttributes(JoinPoint joinPoint, Class<A> annotationType) {
