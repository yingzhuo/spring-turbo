...
public sealed interface ValueStack permits ValueStackImpl {
    ...
    public default String findRequiredString(@Nullable String environmentName, @Nullable String resourceLocation, @Nullable String defaultValue) {
    ...
    public default <T> T findRequiredObject(@NonNull Class<T> valueType, @Nullable String environmentName, @Nullable String resourceLocation, @Nullable String defaultValue) {
