...
public final class WeakThreadSharedObjects {

    /**
     * 按类型保存对象
     */
    private static final ThreadLocal<Map<Class<?>, WeakReference<Object>>> TYPE_HOLDER = ThreadLocal.withInitial(HashMap::new);

    /**
     * 按名称保存对象
     */
    private static final ThreadLocal<Map<String, WeakReference<Object>>> NAME_HOLDER = ThreadLocal.withInitial(HashMap::new);

    /**
     * 私有构造方法
     */
    private WeakThreadSharedObjects() {
    }
    ...
    public static void put(String name, Object obj) {
        NAME_HOLDER.get().put(name, new WeakReference<>(obj));
    }
    ...
    public static <T> void put(Class<T> type, Object obj) {
        TYPE_HOLDER.get().put(type, new WeakReference<>(obj));
    }
